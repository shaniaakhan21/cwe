                ...
                <Tab.Container defaultActiveKey="Week">     
                    <div className="d-flex justify-content-between flex-wrap">
                        <div className="d-flex align-items-center mb-2">
                            <h5 className="me-2 font-w600 m-0"><span className="text-success me-2">BUY</span> $5,673</h5>
                            <h5 className="ms-2 font-w600 m-0"><span className="text-danger me-2">SELL</span> $5,982</h5>
                        </div>
                        <Nav as="ul" className="nav nav-pills justify-content-between mb-2">     
