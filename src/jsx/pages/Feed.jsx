    ...
    return (
        <div className="my-post-content">
            <div className="post-input">
                ...
                <Link to={"#"} className="btn btn-success ms-1" onClick={() => createTimeline()}>Post</Link>
            </div>
                    ...
                    <div key={index} className="profile-uoloaded-post border-bottom-1 mb-5 p-4  border-post">
                        <div>
                            <div className="d-flex justify-content-between align-items-center mb-4">
                                ...
                                {post?.type === 1 && (
                                    <Link className="btn btn-primary me-2 yellow-newbtn" to={`/single-trading/${metadata?.mercado || ''}`} >
