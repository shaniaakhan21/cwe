...
import TiktokIcon from '../../../assets/images/publicpages/TiktokIcon.png';
        ...
        <AppBar position="static" color="transparent" elevation={0} sx={{ borderTop: '1px solid #cea62d', padding: '0' }} className='py-4 footer-cwe' >
            <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'column', alignItems: 'flex-start', padding: '0' }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'start', width: '100%' }}>
                    ...
                    {/* Links */}
                    <Box sx={{ display: 'flex', gap: 5 }} className='w-25'>
                    ...
                    {/* Social Media Icons */}
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 1 }} className='w-65 justify-content-end'>
                        ...
                        <Box sx={{ display: 'flex', gap: 1 }} className='w-25 justify-content-end'>
                            <Button variant="outlined" color="inherit" className='btn-white-cwe  padding-cstm'>Login</Button>
                            <Button variant="contained" className='btn-yellow-cwe  padding-cstm'>Sign Up</Button>
                        </Box>
                    </Box>
                </Box>
            </Toolbar>
